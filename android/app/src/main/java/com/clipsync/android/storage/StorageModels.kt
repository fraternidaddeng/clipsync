...
/** Protocol v1 terminal reasons for sequences whose content is permanently unavailable. */
...
internal fun ClipEventEntity.toSyncable(): SyncableClipEvent = SyncableClipEvent(
    eventId = eventId,
    originDeviceId = originDeviceId,
    originSeq = originSeq,
