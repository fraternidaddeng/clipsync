...
/// <summary>
/// Test-only Windows listener for Stage 4 cross-client E2E. Stdout is the command
/// protocol only; logs go to stderr and never include clip text, secrets, nonces, or proofs.
/// </summary>
